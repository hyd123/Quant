...
if __name__ == "__main__":
    ...
    path = 'D:/gjzqqmt_ceshi/userdata_mini'
    # session_id为会话编号，策略使用方对于不同的Python策略需要使用不同的会话编号
    session_id = 123456
    xt_trader = XtQuantTrader(path, session_id)
    # 创建资金账号为1000000365的证券账号对象
    # acc = StockAccount('55005917')
    # StockAccount可以用第二个参数指定账号类型，如沪港通传'HUGANGTONG'，深港通传'SHENGANGTONG'
    acc = StockAccount('55005917','STOCK')
    # 创建交易回调类对象，并声明接收回调
    ...
    # fix_result_order_id = xt_trader.order_stock(acc, stock_code, xtconstant.STOCK_SELL, 200, xtconstant.FIX_PRICE, 100)
    ...
    # async_seq = xt_trader.order_stock(acc, stock_code, xtconstant.STOCK_BUY, 200, xtconstant.FIX_PRICE, 1)
    # print(async_seq)
    # 查询证券资产
    print("query asset:")
