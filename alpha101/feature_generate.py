...
def alpha46(df):
    ...
    """
    decision1 = (0.25 < (
                ((u.delay(df.close, 20) - u.delay(df.close, 10)) / 10) - ((u.delay(df.close, 10) - df.close) / 10)))
    decision2 = ((((u.delay(df.close, 20) - u.delay(df.close, 10)) / 10) - (
                (u.delay(df.close, 10) - df.close) / 10)) < 0)
...
def alpha49(df):
    ...
    return pd.Series(np.where(((temp1 - temp2) < (-1 * 0.1)), 1, ((-1 * 1) * (df.close - u.delay(df.close, 1)))),
                     index=df.index)
...
def get_all_factors(df):
    all_factors = [alpha1(df), alpha2(df), alpha3(df), alpha4(df), alpha5(df),
                   alpha6(df), alpha7(df), alpha8(df), alpha9(df), alpha10(df),
                   alpha11(df), alpha12(df), alpha13(df), alpha14(df), alpha15(df),
                   alpha16(df), alpha17(df), alpha18(df), alpha19(df), alpha20(df),
                   alpha21(df), alpha22(df), alpha23(df), alpha24(df), alpha25(df),
                   alpha26(df), alpha27(df), alpha28(df), alpha29(df), alpha30(df),
                   alpha31(df), alpha32(df), alpha33(df), alpha34(df), alpha35(df),
                   alpha36(df), alpha37(df), alpha38(df), alpha39(df), alpha40(df),
                   alpha41(df), alpha42(df), alpha43(df), alpha44(df), alpha45(df),
                   alpha46(df), alpha47(df), alpha49(df), alpha50(df), alpha51(df),
                   alpha52(df), alpha53(df), alpha54(df), alpha55(df), alpha57(df),
                   alpha60(df),  alpha62(df), alpha64(df), alpha65(df),
                   alpha66(df), alpha68(df), alpha71(df), alpha72(df), alpha73(df),
                   alpha74(df), alpha77(df), alpha78(df), alpha81(df),
                   alpha83(df), alpha84(df), alpha85(df), alpha86(df), alpha88(df),
                    alpha92(df),   alpha96(df),
                   alpha98(df), alpha99(df), alpha101(df)]
    new_data = pd.DataFrame()
    for i in range(len(all_factors)):
        new_data['feature' + str(i)] = all_factors[i]
    return new_data
